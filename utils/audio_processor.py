...
def download_youtube_audio(url: str) -> str:
    ...
    ydl_opts = {
        ...
        "quiet": True,
        "js_runtimes": {"node": {}},
        "extractor_args": {"youtube": ["player_client=ios,tv,-android_sdkless"]},
    }
...
def get_video_id(url: str) -> str | None:
    ...
    ydl_opts = {"quiet": True, "js_runtimes": {"node": {}}, "extractor_args": {"youtube": ["player_client=ios,tv,-android_sdkless"]}}
    if os.path.exists("cookies.txt"):
        ydl_opts["cookiefile"] = "cookies.txt"
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
